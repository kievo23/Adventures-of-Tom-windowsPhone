...
(function () {
	...
	function handleComplete(event) {
	    ...
	    var palmvar = preload.getResult('palm');
	    palm = new createjs.Bitmap(palmvar);
	    palm.x = 1000;
	    palm.y = 60;
	    ...
	    //Text in the game
	    stage.addChild(circle, tree, cake, palm, tulips, tom, slayer, progres, progressive, scoreImg, healthImg, healthd, levelO, girl);
        ...
        .to({ x: 230, y: 170 }, 2500, createjs.Ease.getPowInOut(1))
        .to({ x: 290, y: 210 }, 4500, createjs.Ease.getPowInOut(1));

	    //Tween Tom
	    createjs.Tween.get(tom, { loop: true })
        .to({ x: 160 }, 2500, createjs.Ease.getPowInOut(1))
	    ...
	    //TWEEN Palm
	    createjs.Tween.get(palm, { loop: true })
        .to({ x: Math.floor(Math.random()) }, 8000, createjs.Ease.getPowInOut(1))
	    .to({ x: -600 }, 4000, createjs.Ease.getPowInOut(1));
